      ...
      decoration: InputDecoration(
          ...
          prefixIcon: Padding(
            ...
            child: SvgPicture.asset(
              "${Constant.assetImagePath}${prefixiconimage}",
              height: 24.h,
              width: 24.w,
            ),
          ),
...
Widget getSendMessegeContainer(String messege,
  ...
  return Align(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
          ...
          color: lightPacific),
      child: Center(
              child: getMultilineCustomFont(messege, 14.sp, regularBlack,
                  fontWeight: FontWeight.w400,
...
Widget getEditProfileOptionFormate(
    {String? iconImage,
    String? hint,
    String? userdetail,
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
      ...
      focusedBorder:
          UnderlineInputBorder(borderSide: BorderSide(color: pacificBlue)),
    ),
  );
}
...
Widget getNotificationDataFormat(
  String userimage,
  String userName,
  String time, {
  String? firstText,
            ...
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    getMultilineCustomFont(userName, 14.sp, regularBlack,
                        fontWeight: FontWeight.w600, txtHeight: 1.5.h),
                    getCustomFont(time, 12.sp, hintColor, 1,
                        fontWeight: FontWeight.w400, txtHeight: 1.5.h)
                  ],
                ),
                getVerSpace(3.h),
