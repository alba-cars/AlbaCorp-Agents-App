...
import '../view/add_ticket_screen/cubit/add_ticket_cubit.dart' as _i60;
...
import '../view/lead_source/presentation/cubit/lead_source_cubit.dart' as _i67;
...
import '../view/listings_screen/cubit/listings_cubit.dart' as _i66;
import '../view/login/cubit/login_cubit.dart' as _i21;
import '../view/my_activities/cubit/my_activities_cubit.dart' as _i54;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i52.AddPocketListingCubit>(() => _i52.AddPocketListingCubit(
          gh<_i27.LeadRepo>(),
          gh<_i15.ListingsRepo>(),
          gh<_i22.ExplorerRepo>(),
        ));
    gh.factoryParam<_i53.PropertyCardDetailsCubit, String, dynamic>((
      propertyCardId,
      _,
    ) =>
        _i53.PropertyCardDetailsCubit(
          propertyCardId,
          gh<_i22.ExplorerRepo>(),
        ));
    ...
    gh.factoryParam<_i61.AddListingCubit, bool, _i62.Deal?>((
      _isEdit,
      _deal,
    ) =>
        _i61.AddListingCubit(
          gh<_i27.LeadRepo>(),
          gh<_i15.ListingsRepo>(),
          gh<_i25.DealsRepo>(),
          _isEdit,
    ...
    gh.factoryParam<_i63.AddFollowupCubit, String, dynamic>((
      leadId,
      _,
    ) =>
        _i63.AddFollowupCubit(
          gh<_i27.LeadRepo>(),
          gh<_i19.ActivityRepo>(),
          gh<_i17.AgentRepo>(),
          leadId,
    ...
    gh.factory<_i64.LeadsListExplorerCubit>(() => _i64.LeadsListExplorerCubit(
          gh<_i22.ExplorerRepo>(),
          gh<_i15.ListingsRepo>(),
        ));
    gh.factoryParam<_i65.AddDealCubit, _i62.Deal?, dynamic>((
      deal,
      _,
    ) =>
        _i65.AddDealCubit(
    ...
    gh.factory<_i66.ListingsCubit>(() => _i66.ListingsCubit(
          gh<_i15.ListingsRepo>(),
          gh<_i22.ExplorerRepo>(),
          gh<_i17.AgentRepo>(),
        ));
    gh.factory<_i67.LeadSourceCubit>(
        () => _i67.LeadSourceCubit(leadData: gh<_i27.LeadRepo>()));
    return this;
  }
}

class _$RegisterModules extends _i68.RegisterModules {}
