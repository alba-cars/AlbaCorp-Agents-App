...
import '../view/call_feedback_screen/cubit/call_feedback_cubit.dart' as _i51;
...
import '../view/home_screen/cubit/home_cubit.dart' as _i47;
...
import '../view/tickets_screen/cubit/tickets_screen_cubit.dart' as _i48;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i48.TicketsScreenCubit>(
        () => _i48.TicketsScreenCubit(gh<_i32.TicketRepo>()));
    gh.factory<_i49.AddPocketListingCubit>(() => _i49.AddPocketListingCubit(
          gh<_i27.LeadRepo>(),
          gh<_i16.ListingsRepo>(),
          gh<_i23.ExplorerRepo>(),
        ));
    gh.factoryParam<_i50.PropertyCardDetailsCubit, String, dynamic>((
      propertyCardId,
      _,
    ) =>
        _i50.PropertyCardDetailsCubit(
          propertyCardId,
          gh<_i23.ExplorerRepo>(),
        ));
    gh.factory<_i51.CallFeedbackCubit>(() => _i51.CallFeedbackCubit(
          gh<_i27.LeadRepo>(),
          gh<_i6.PendingCallFeedbackRepo>(),
          gh<_i20.ActivityRepo>(),
        ));
