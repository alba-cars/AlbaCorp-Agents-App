...
class _HomePageLayoutState extends State<HomePageLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    return NestedScrollView(
      ...
      body: BlocSelector<HomeCubit, HomeState, Status>(
        selector: (state) {
          return state.getActivitiesStatus;
        },
        builder: (context, getActivitiesStatus) {
          if (getActivitiesStatus == Status.loading) {
            return Center(
              child: CircularProgressIndicator(),
            );
          }
          final activities = context.read<HomeCubit>().state.activities;
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // Padding(
