      ...
      builder: (context, state) {
        ...
        return NotificationListener<ScrollNotification>(
          ...
          child: RefreshIndicator.adaptive(
            onRefresh: () async {
              await context.read<ListingsCubit>().getListings(refresh: true);
            },
        ...
        return NotificationListener<ScrollNotification>(
          ...
          child: RefreshIndicator.adaptive(
            ...
            child: ListView.separated(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InfoLabelValue(
                          ...
                          valueTwo:
                              propertyCard.community?.community.toString(),
                        ),
                        InfoLabelValue(
                          labelOne: 'Area',
                ...
                itemCount: state.getPocketListingsStatus == Status.loadingMore
